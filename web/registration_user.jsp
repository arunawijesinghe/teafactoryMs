    ...
    <body style="background:#fff">
        ...
        <div class="container" style="background:#ebebeb">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="#"><b><font color="Black">Registration <span class="glyphicon glyphicon-bishop"></span></font></b></a></li>
            ...
            <div class="well">
                ...
                <form method="post" action="verifyRegistration_user.jsp"class="form-group" name="reg">
                    <div class="row">
                        <div class="col-md-6">
