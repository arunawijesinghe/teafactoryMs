                            ...
                            <form name="change" method="post" action="UpdatePassword"> 
                                <table border="0" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="password" class="form-control" name="c_pword" required="true">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="password" class="form-control" name="nw_pword"required="true">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="password" class="form-control" name="rnw_pword" required="true" onblur="checkPassword()">
                                        </td>
