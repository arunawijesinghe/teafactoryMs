...
import com.fims.service.TransportService;
...
public class AddTransportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            double totWeight = Double.parseDouble(request.getParameter("tot"));
            double montrate = Double.parseDouble(request.getParameter("mrate"));
            ...
            transport.setSystemId(sysid);
            transport.setTdate(sdate);
            transport.setTransId(transId);
            transport.setTotWeight(totWeight);
            transport.setMonthRate(montrate);
            transport.setTotPay(price);
            
            TransportService.addTransportService(transport);
